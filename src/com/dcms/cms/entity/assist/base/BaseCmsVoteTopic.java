...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	// collections
	private java.util.Set<com.dcms.cms.entity.assist.CmsVoteItem> items;
	private java.util.Set<com.dcms.cms.entity.assist.CmsVoteSubTopic> subtopics;
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.assist.CmsVoteItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.dcms.cms.entity.assist.CmsVoteItem> items) {
		this.items = items;
	}

	public java.util.Set<com.dcms.cms.entity.assist.CmsVoteSubTopic> getSubtopics() {
		return subtopics;
	}

	public void setSubtopics(
			java.util.Set<com.dcms.cms.entity.assist.CmsVoteSubTopic> subtopics) {
		this.subtopics = subtopics;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.dcms.cms.entity.assist.CmsVoteTopic)) return false;
		else {
			com.dcms.cms.entity.assist.CmsVoteTopic cmsVoteTopic = (com.dcms.cms.entity.assist.CmsVoteTopic) obj;
