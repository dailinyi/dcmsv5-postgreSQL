...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.dcms.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.dcms.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.dcms.cms.entity.main.CmsUser member;
	private com.dcms.cms.entity.main.CmsUser admin;
	private com.dcms.cms.entity.main.CmsSite site;
	private com.dcms.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.dcms.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.dcms.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.dcms.cms.entity.main.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.dcms.cms.entity.main.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.dcms.cms.entity.main.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.dcms.cms.entity.main.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.dcms.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.dcms.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.dcms.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.dcms.cms.entity.assist.CmsGuestbook) obj;
