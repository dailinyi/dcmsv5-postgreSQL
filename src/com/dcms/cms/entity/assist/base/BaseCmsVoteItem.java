...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	public BaseCmsVoteItem (
		...
		com.dcms.cms.entity.assist.CmsVoteTopic topic,
	...
	// many to one
	private com.dcms.cms.entity.assist.CmsVoteTopic topic;
	private com.dcms.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.dcms.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.dcms.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.dcms.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.dcms.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.dcms.cms.entity.assist.CmsVoteItem)) return false;
		else {
			com.dcms.cms.entity.assist.CmsVoteItem cmsVoteItem = (com.dcms.cms.entity.assist.CmsVoteItem) obj;
