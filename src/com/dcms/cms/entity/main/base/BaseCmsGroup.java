...
public abstract class BaseCmsGroup  implements Serializable {
	...
	// collections
	private java.util.Set<com.dcms.cms.entity.main.Channel> viewChannels;
	private java.util.Set<com.dcms.cms.entity.main.Channel> contriChannels;
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.Channel> getViewChannels () {
		return viewChannels;
	}
	 ...
	 */
	public void setViewChannels (java.util.Set<com.dcms.cms.entity.main.Channel> viewChannels) {
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.Channel> getContriChannels () {
	 ...
	 */
	public void setContriChannels (java.util.Set<com.dcms.cms.entity.main.Channel> contriChannels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.main.CmsGroup)) return false;
		else {
			com.dcms.cms.entity.main.CmsGroup cmsGroup = (com.dcms.cms.entity.main.CmsGroup) obj;
