...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.dcms.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.dcms.cms.entity.main.ChannelExt channelExt;

	// many to one
	private com.dcms.cms.entity.main.CmsSite site;
	private com.dcms.cms.entity.main.CmsModel model;
	private com.dcms.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.dcms.cms.entity.main.Channel> child;
	private java.util.Set<com.dcms.cms.entity.main.CmsGroup> viewGroups;
	private java.util.Set<com.dcms.cms.entity.main.CmsGroup> contriGroups;
	private java.util.Set<com.dcms.cms.entity.main.CmsUser> users;
	private java.util.Set<com.dcms.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.dcms.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.dcms.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.dcms.cms.entity.main.ChannelExt channelExt) {
	 ...
	 */
	public com.dcms.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.dcms.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.dcms.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.dcms.cms.entity.main.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.dcms.cms.entity.main.CmsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.dcms.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.dcms.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.dcms.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.main.Channel)) return false;
		else {
			com.dcms.cms.entity.main.Channel channel = (com.dcms.cms.entity.main.Channel) obj;
