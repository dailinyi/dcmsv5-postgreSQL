...
public abstract class BaseContentCount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.main.ContentCount)) return false;
		else {
			com.dcms.cms.entity.main.ContentCount contentCount = (com.dcms.cms.entity.main.ContentCount) obj;
