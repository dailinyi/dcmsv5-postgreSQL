...
public abstract class BaseCmsModel  implements Serializable {
	...
	// collections
	private java.util.Set<com.dcms.cms.entity.main.CmsModelItem> items;
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.CmsModelItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.dcms.cms.entity.main.CmsModelItem> items) {
		this.items = items;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.main.CmsModel)) return false;
		else {
			com.dcms.cms.entity.main.CmsModel cmsModel = (com.dcms.cms.entity.main.CmsModel) obj;
