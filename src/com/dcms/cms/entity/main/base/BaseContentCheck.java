...
public abstract class BaseContentCheck  implements Serializable {
	...
	private com.dcms.cms.entity.main.CmsUser reviewer;
	...
	public com.dcms.cms.entity.main.CmsUser getReviewer() {
		return reviewer;
	}

	public void setReviewer(com.dcms.cms.entity.main.CmsUser reviewer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.main.ContentCheck)) return false;
		else {
			com.dcms.cms.entity.main.ContentCheck contentCheck = (com.dcms.cms.entity.main.ContentCheck) obj;
