...
public abstract class BaseContent  implements Serializable {
	...
	public BaseContent (
		...
		com.dcms.cms.entity.main.CmsSite site,
	...
	// one to one
	private com.dcms.cms.entity.main.ContentExt contentExt;
	private com.dcms.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.dcms.cms.entity.main.ContentType type;
	private com.dcms.cms.entity.main.CmsSite site;
	private com.dcms.cms.entity.main.CmsUser user;
	private com.dcms.cms.entity.main.Channel channel;
	private com.dcms.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.dcms.cms.entity.main.Channel> channels;
	private java.util.Set<com.dcms.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.dcms.cms.entity.main.CmsGroup> viewGroups;
	private java.util.List<com.dcms.cms.entity.main.ContentTag> tags;
	private java.util.List<com.dcms.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.dcms.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.dcms.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.dcms.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.dcms.cms.entity.main.CmsUser> collectUsers;
	private java.util.Set<com.dcms.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.dcms.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.dcms.cms.entity.assist.CmsJobApply> jobApplys;
	...
	public java.util.Set<com.dcms.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.dcms.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}

	public java.util.Set<com.dcms.cms.entity.assist.CmsJobApply> getJobApplys() {
		return jobApplys;
	}

	public void setJobApplys(
			java.util.Set<com.dcms.cms.entity.assist.CmsJobApply> jobApplys) {
	 ...
	 */
	public com.dcms.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.dcms.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.dcms.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.dcms.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.dcms.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.dcms.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public com.dcms.cms.entity.main.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (com.dcms.cms.entity.main.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public com.dcms.cms.entity.main.CmsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.dcms.cms.entity.main.CmsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.dcms.cms.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (com.dcms.cms.entity.main.Channel channel) {
		this.channel = channel;
	}
	
	public com.dcms.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.dcms.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.dcms.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.dcms.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.dcms.cms.entity.main.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.dcms.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.dcms.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.dcms.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.dcms.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.dcms.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.dcms.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.dcms.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.dcms.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.dcms.cms.entity.main.ContentCheck> contentCheckSet) {
	...
	public java.util.Set<com.dcms.cms.entity.main.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.dcms.cms.entity.main.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.dcms.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.dcms.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.dcms.cms.entity.main.Content)) return false;
		else {
			com.dcms.cms.entity.main.Content content = (com.dcms.cms.entity.main.Content) obj;
